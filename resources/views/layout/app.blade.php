...
<body>
  ...
  <script src="{{ asset ('template/datatables.net/jquery.dataTables.js')}}"></script>
  <script src="{{ asset ('templatevendors/datatables.net-bs4/dataTables.bootstrap4.js')}}"></script>
